...
int act1 = 1; //acturador
int act2 = 3; //actuador
int sensor_b = 15; 
int agua = 13; //sistema de riego
int DHTPIN = 12;
...
int luz1 = 14; //iluminación
int luz2 = 2; //iluminación
// 0 para servomotor
int luz_exterior = 4;
int digital_ldr = 5;
int pir = 16;
...
//--------Sistemas de control----------
char str_hum_data[10]; //Humadad para el sistema de riego
char str_temp_data[10]; //Temperatura exterior
...
//------------Asignación de las variable Salidas/Entradas------------
void setup() {
  Serial.begin(115200);
  setup_wifi();
...
//------Sistema de reconexión, en caso desconexio------
void reconnect(){
